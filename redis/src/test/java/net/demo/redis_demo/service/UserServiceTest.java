package net.demo.redis_demo.service;
...
@Slf4j
public class UserServiceTest extends RedisDemoApplicationTests {
    @Autowired
    ...
    public void getAfterSave() {
        userService.saveOrUpdate(User.builder().id(4L).name("中文").build());
